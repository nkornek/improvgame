...
public class PropScript : MonoBehaviour {
    ...
    public int playerNum, act, scene;
		...
		case PropTypes.clothesHat:
			foreach (GameObject g in GameObject.FindGameObjectsWithTag("Player"))
			{
				if (g.GetComponent<SaveSkeleton>().player == playerNum)
				{
					...
					gameObject.GetComponent<ClothesAndHat>().hat.transform.localRotation = gameObject.GetComponent<ClothesAndHat>().hat.transform.parent.rotation;
					...
					gameObject.GetComponent<ClothesAndHat>().clothes.transform.localRotation = gameObject.GetComponent<ClothesAndHat>().clothes.transform.parent.rotation; 
				}
			}
			break;
		case PropTypes.Head:
